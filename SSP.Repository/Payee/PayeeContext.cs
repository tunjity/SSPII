...
public partial class PayeeContext : DbContext
{
    ...
    public virtual DbSet<Business1> Businesses1 { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Business1>(entity =>
        {
            entity.HasKey(e => e.BusinessId);
        ...
        modelBuilder.Entity<FormReassessment>(entity =>
        {
            ...
            entity.Property(e => e.CompanyId).HasColumnName("CompanyID");
            entity.Property(e => e.Formassessment).HasColumnType("numeric(18, 0)");
            entity.Property(e => e.Id)
                .ValueGeneratedOnAdd()
                .HasColumnName("ID");
            entity.Property(e => e.Interest).HasColumnType("numeric(18, 0)");
            entity.Property(e => e.Penalty).HasColumnType("numeric(18, 0)");
            entity.Property(e => e.SumMonthlyassessment).HasColumnType("numeric(18, 0)");
            entity.Property(e => e.TaxYear).HasColumnType("date");
            entity.Property(e => e.TotalReassessment).HasColumnType("numeric(18, 0)");
            entity.Property(e => e.UnderAssessment).HasMaxLength(50);
        });
