...
public partial class PinscherSpikeContext : DbContext
{
    ...
    public virtual DbSet<BusinessesBkApi> BusinessesBkApis { get; set; }
    ...
    public virtual DbSet<CompaniesApi> CompaniesApis { get; set; }

    public virtual DbSet<Company> Companies { get; set; }

    public virtual DbSet<CompanyListApi> CompanyListApis { get; set; }

    public virtual DbSet<CompanyListBkApi> CompanyListBkApis { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BusinessesBkApi>(entity =>
        {
            entity.HasKey(e => e.BusinessId);

            entity.ToTable("BusinessesBK_API");
        ...
        modelBuilder.Entity<CompaniesApi>(entity =>
        {
            entity.HasKey(e => e.CompanyId).HasName("PK_CompaniesAPI");

            entity.ToTable("Companies_API");
            ...
            entity.Property(e => e.Active)
                .HasMaxLength(10)
                .IsUnicode(false);
            entity.Property(e => e.ActiveText)
                .HasMaxLength(10)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<CompanyListBkApi>(entity =>
        {
            entity.HasKey(e => e.TaxPayerId);

            entity.ToTable("CompanyListBK_API");
